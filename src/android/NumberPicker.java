...
public class NumberPicker extends View {
	...
	private void readAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		int attrId2 = context.getResources().getIdentifier("textSize", "attr", context.getPackageName());
		final TypedArray b = context.obtainStyledAttributes(attrs, new int[]{attrId2}, defStyleAttr, 0);
		mTextSize = b.getDimension(fakeR.getId("styleable","NumberPicker_textSize"), DEFAULT_TEXT_SIZE * mDensity);

		int attrId3 = context.getResources().getIdentifier("startNumber", "attr", context.getPackageName());
		final TypedArray c = context.obtainStyledAttributes(attrs, new int[]{attrId3}, defStyleAttr, 0);
		mStartNumber = c.getInteger(fakeR.getId("styleable","NumberPicker_startNumber"), 0);

		int attrId4 = context.getResources().getIdentifier("endNumber", "attr", context.getPackageName());
		final TypedArray d = context.obtainStyledAttributes(attrs, new int[]{attrId4}, defStyleAttr, 0);
		mEndNumber = d.getInteger(fakeR.getId("styleable","NumberPicker_endNumber"), 0);

		int attrId5 = context.getResources().getIdentifier("currentNumber", "attr", context.getPackageName());
		final TypedArray e = context.obtainStyledAttributes(attrs, new int[]{attrId5}, defStyleAttr, 0);
		mCurrentNumber = e.getInteger(fakeR.getId("styleable","NumberPicker_currentNumber"), 0);

		int attrId6 = context.getResources().getIdentifier("verticalSpacing", "attr", context.getPackageName());
		final TypedArray f = context.obtainStyledAttributes(attrs, new int[]{attrId6}, defStyleAttr, 0);
		mVerticalSpacing = (int) f.getDimension(fakeR.getId("styleable","NumberPicker_verticalSpacing"), DEFAULT_VERTICAL_SPACING * mDensity);

		int attrId7 = context.getResources().getIdentifier("flagText", "attr", context.getPackageName());
		final TypedArray g = context.obtainStyledAttributes(attrs, new int[]{attrId7}, defStyleAttr, 0);
		mFlagText = g.getString(fakeR.getId("styleable","NumberPicker_flagText"));

		int attrId8 = context.getResources().getIdentifier("flagTextColor", "attr", context.getPackageName());
		final TypedArray h = context.obtainStyledAttributes(attrs, new int[]{attrId8}, defStyleAttr, 0);
		mFlagTextColor = h.getColor(fakeR.getId("styleable","NumberPicker_flagTextColor"), DEFAULT_FLAG_TEXT_COLOR);

		int attrId9 = context.getResources().getIdentifier("flagTextSize", "attr", context.getPackageName());
		final TypedArray i = context.obtainStyledAttributes(attrs, new int[]{attrId8}, defStyleAttr, 0);
		mFlagTextSize = i.getDimension(fakeR.getId("styleable","NumberPicker_flagTextSize"), DEFAULT_FLAG_TEXT_SIZE * mDensity);

		int attrId10 = context.getResources().getIdentifier("backgroundColor", "attr", context.getPackageName());
		final TypedArray j = context.obtainStyledAttributes(attrs, new int[]{attrId10}, defStyleAttr, 0);
		mBackgroundColor = j.getColor(fakeR.getId("styleable","NumberPicker_backgroundColor"), DEFAULT_BACKGROUND_COLOR);

		int attrId11 = context.getResources().getIdentifier("rowNumber", "attr", context.getPackageName());
		final TypedArray k = context.obtainStyledAttributes(attrs, new int[]{attrId11}, defStyleAttr, 0);
		mRowNumber = k.getInteger(fakeR.getId("styleable","NumberPicker_rowNumber"), DEFAULT_LINES);
		a.recycle();
	}
